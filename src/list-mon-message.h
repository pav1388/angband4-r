...
MON_MSG(SPAWN,				MSG_GENERIC,	false,	"размножа[ется|аются]!")
...
MON_MSG(MORE_CONFUSED,		MSG_GENERIC,	false,	"выгляд[ит|ят] сильно растерянным[и].")
// MON_MSG(CONFUSED,			MSG_GENERIC,	false,	"look[s] confused.")
MON_MSG(CONFUSED,			MSG_GENERIC,	false,	"выгляд[ит|ят] растерянным[и].")
// MON_MSG(NOT_CONFUSED,		MSG_GENERIC,	false,	"[is|are] no longer confused.")
MON_MSG(NOT_CONFUSED,		MSG_GENERIC,	false,	"больше не растерян[ы].")
// MON_MSG(MORE_SLOWED,		MSG_GENERIC,	false,	"look[s] more slowed.")
MON_MSG(MORE_SLOWED,		MSG_GENERIC,	false,	"выгляд[ит|ят] сильно медленным[и].")
// MON_MSG(SLOWED,				MSG_GENERIC,	false,	"look[s] slowed.")
MON_MSG(SLOWED,				MSG_GENERIC,	false,	"выгляд[ит|ят] медленным[и].")
...
MON_MSG(MORE_HASTED,		MSG_GENERIC,	false,	"выгляд[ит|ят] более быстрым[и]!")
...
MON_MSG(MORE_AFRAID,		MSG_GENERIC,	false,	"выгляд[ит|ят] сильно испуганным[и]!")
...
MON_MSG(DISEN,				MSG_GENERIC,    false,  "выгляд[ит|ят] менее магическим[и]!")
// MON_MSG(NOT_DISEN,			MSG_GENERIC,    false,  "seem[s] magical again.")
MON_MSG(NOT_DISEN,			MSG_GENERIC,    false,  "снова выгляд[ит|ят] магическим[и].")
...
MON_MSG(BRIEF_PUZZLE,		MSG_GENERIC,	false,	"выгляд[ит|ят] озадаченным[и].")
...
MON_MSG(UNHARMED,			MSG_GENERIC,	false,	"остал[ся|ись] невредимым[и].")
