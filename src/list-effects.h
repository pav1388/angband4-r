...
EFFECT(RANDOM,						false,	NULL,		0,		EFINFO_NONE,	"случайно ",	"")
// EFFECT(DAMAGE,						false,	"hurt",		1,		EFINFO_DICE,	"does %s damage to the player",	"")
EFFECT(DAMAGE,						false,	"hurt",		1,		EFINFO_DICE,	"наносит %s урона игроку",	"")
// EFFECT(HEAL_HP,						false,	"heal",		2,		EFINFO_HEAL,	"heals %s hitpoints%s",	"heal self")
EFFECT(HEAL_HP,						false,	"heal",		2,		EFINFO_HEAL,	"восполняет %s ОЗ%s",	"самолечение")
// EFFECT(MON_HEAL_HP,					false,	NULL,		0,		EFINFO_NONE,	"heals monster hitpoints",	"")
EFFECT(MON_HEAL_HP,					false,	NULL,		0,		EFINFO_NONE,	"восполняет ОЗ монстра",	"")
// EFFECT(MON_HEAL_KIN,				false,	NULL,		0,		EFINFO_NONE,	"heals fellow monster hitpoints",	"")
EFFECT(MON_HEAL_KIN,				false,	NULL,		0,		EFINFO_NONE,	"восполняет ОЗ монстра-соратника",	"")
// EFFECT(NOURISH,						false,	NULL,		3,		EFINFO_FOOD,	"%s for %s turns (%s percent)",	"%s %s")
EFFECT(NOURISH,						false,	NULL,		3,		EFINFO_FOOD,	"%s %s ходов (%s%%)",	"%s %s")
// EFFECT(CRUNCH,						false,	NULL,		0,		EFINFO_NONE,	"crunches",	"")
EFFECT(CRUNCH,						false,	NULL,		0,		EFINFO_NONE,	"crunches",	"") // не переведено
// EFFECT(CURE,						false,	NULL,		1,		EFINFO_CURE,	"cures %s",	"cure %s")
EFFECT(CURE,						false,	NULL,		1,		EFINFO_CURE,	"лечит %s",	"лечить %s")
// EFFECT(TIMED_SET,					false,	NULL,		2,		EFINFO_TIMED,	"administers %s for %s turns",	"administer %s")
EFFECT(TIMED_SET,					false,	NULL,		2,		EFINFO_TIMED,	"управляет %s %s ходов",	"управлять %s")
// EFFECT(TIMED_INC,					false,	"dur",		2,		EFINFO_TIMED,	"extends %s for %s turns",	"extend %s")
EFFECT(TIMED_INC,					false,	"dur",		2,		EFINFO_TIMED,	"расширяет %s на %s ходов",	"расширить %s")
// EFFECT(TIMED_INC_NO_RES,			false,	"dur",		2,		EFINFO_TIMED,	"extends %s for %s turns (unresistable)",	"extend %s")
EFFECT(TIMED_INC_NO_RES,			false,	"dur",		2,		EFINFO_TIMED,	"расширяет %s на %s ходов (неустойчиво)",	"расширить %s")
// EFFECT(MON_TIMED_INC,				false,	NULL,		2,		EFINFO_TIMED,	"increases monster %s by %s turns",	"")
EFFECT(MON_TIMED_INC,				false,	NULL,		2,		EFINFO_TIMED,	"увеличивает количество монстров %s на %s ходов",	"")
...
EFFECT(SELECT,						false,	NULL,		0,		EFINFO_NONE,	"выбирает один из ",	"")
