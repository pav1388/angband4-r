...
ORIGIN(DROP,		2,	"Выпало с %s %s") /* normal monster drops */
// ORIGIN(DROP_SPECIAL,2,	"Dropped by %s %s") /* from monsters in special rooms */
ORIGIN(DROP_SPECIAL,2,	"Выпало с %s %s") /* from monsters in special rooms */
// ORIGIN(DROP_PIT,	2,	"Dropped by %s %s") /* from monsters in pits/nests */
ORIGIN(DROP_PIT,	2,	"Выпало с %s %s") /* from monsters in pits/nests */
// ORIGIN(DROP_VAULT,	2,	"Dropped by %s %s") /* from monsters in vaults */
ORIGIN(DROP_VAULT,	2,	"Выпало с %s %s") /* from monsters in vaults */
...
ORIGIN(DROP_BREED,	2,	"Выпало с %s %s") /* from breeders */
// ORIGIN(DROP_SUMMON,	2,	"Dropped by %s %s") /* from combat summons */
ORIGIN(DROP_SUMMON,	2,	"Выпало с %s %s") /* from combat summons */
// ORIGIN(DROP_UNKNOWN,1,	"Dropped by an unknown monster %s")
ORIGIN(DROP_UNKNOWN,1,	"Выпало с неизвестного монстра %s")
// ORIGIN(DROP_POLY,	2,	"Dropped by %s %s") /* from polymorphees */
ORIGIN(DROP_POLY,	2,	"Выпало с %s %s") /* from polymorphees */
// ORIGIN(DROP_MIMIC,	2,	"Dropped by %s %s") /* from mimics */
ORIGIN(DROP_MIMIC,	2,	"Выпало с %s %s") /* from mimics */
// ORIGIN(DROP_WIZARD,	2,	"Dropped by %s %s") /* from wizard mode summons */
ORIGIN(DROP_WIZARD,	2,	"Выпало с %s %s") /* from wizard mode summons */
