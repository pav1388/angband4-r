...
EQUIP(WEAPON,		false,	false,	"Оружие",		"just lifting",	"attacking monsters with")
// EQUIP(BOW,			false,	false,	"Shooting",		"just holding",	"shooting missiles with")
EQUIP(BOW,			false,	false,	"Стрельба",		"just holding",	"shooting missiles with")
// EQUIP(RING,			false,	true,	"On %s",		"",				"wearing on your %s")
EQUIP(RING,			false,	true,	"На %s",		"",				"wearing on your %s")
// EQUIP(AMULET,		false,	true,	"Around %s",	"",				"wearing around your %s")
EQUIP(AMULET,		false,	true,	"Вокруг %s",	"",				"wearing around your %s")
// EQUIP(LIGHT,		false,	false,	"Light source",	"",				"using to light your way")
EQUIP(LIGHT,		false,	false,	"Освещение",	"",				"using to light your way")
// EQUIP(BODY_ARMOR,	true,	true,	"On %s",		"",				"wearing on your %s")
EQUIP(BODY_ARMOR,	true,	true,	"На %s",		"",				"wearing on your %s")
// EQUIP(CLOAK,		true,	true,	"On %s",		"",				"wearing on your %s")
EQUIP(CLOAK,		true,	true,	"На %s",		"",				"wearing on your %s")
// EQUIP(SHIELD,		true,	true,	"On %s",		"",				"wearing on your %s")
EQUIP(SHIELD,		true,	true,	"В %s",		"",				"wearing on your %s")
// EQUIP(HAT,			true,	true,	"On %s",		"",				"wearing on your %s")
EQUIP(HAT,			true,	true,	"На %s",		"",				"wearing on your %s")
// EQUIP(GLOVES,		true,	true,	"On %s",		"",				"wearing on your %s")
EQUIP(GLOVES,		true,	true,	"На %s",		"",				"wearing on your %s")
// EQUIP(BOOTS,		true,	true,	"On %s",		"",				"wearing on your %s")
EQUIP(BOOTS,		true,	true,	"На %s",		"",				"wearing on your %s")
